...
\svgsetup{inkscapeversion=1,inkscapepath=./figures/, inkscapedpi=600, inkscapearea=page, inkscapelatex=true, inkscapeformat=png, extractformat={pdf},clean=true, extractpath=./fig}
% \svgsetup{inkscapeversion=2,inkscapepath=./figures/, inkscapedpi=600, inkscapearea=page, inkscapelatex=false, inkscapeformat=png}

% PDF comments
\pdfcommentsetup{final}

% PDF comments
\newcommand{\crt}[1]{\hl{#1}}
% \NewDocumentCommand{\crt}{+m}{\hl{#1}}
% \newcommand{\crt}[1]{{#1}}
...
% --- Register commands with soulutf8 ---
% For citations (adjust number if not using biblatex, 7 is common for biblatex)
\soulregister\cite7
\soulregister\citet7 % If you use \citet, etc.
\soulregister\citep7 % If you use \citep, etc.

\soulregister\hyperref 2 % For \hyperref (if used directly or by \secref)

% It's possible \cite* is covered by \cite, but if not:
\soulregister\citestar7 % Or \soulregister\citeast7 depending on backend
% For your custom commands
\soulregister\figref 2
% \soulregister\secref1
\soulregister\refcite1
\soulregister\apref1
\soulregister\tableref1
\soulregister\equationref1
\soulregister\algoref1
% % For commands used internally by your custom commands
\soulregister\hyperref2
\soulregister\refstar1
\soulregister\ref1
\soulregister\sectionref1
% For math-related commands from your new request
\soulregister\mathrm1    % \mathrm takes 1 argument
\soulregister\vb1      % Your custom \vb command takes 1 argument
\soulregister\bm1      % Since \vb uses \bm, register \bm (takes 1 argument)
\soulregister\subsubsection2
